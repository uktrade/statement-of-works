...
var StyledTable = styled('table')(typography.font({
  size: 19
...
var Table = function Table(_ref) {
  ...
  return React.createElement(StyledTable, props, caption && React.createElement(Caption, null, caption), head && React.createElement(TableHeader, null, head), React.createElement(TableBody, null, body));
};
