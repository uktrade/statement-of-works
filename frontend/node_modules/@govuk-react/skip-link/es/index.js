...
var SkipLink = styled('a')(visuallyHidden.focusable(), link.common(), link.styleText, typography.responsive(16), {
  display: 'block',
...
var SkipLinkDocumented = function SkipLinkDocumented(props) {
  return React.createElement(SkipLink, props);
};
