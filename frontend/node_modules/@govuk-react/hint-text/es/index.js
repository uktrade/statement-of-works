...
var StyledHint = styled('span')(typography.font({
  size: 19
}), {
  display: 'block',
...
}, spacing.withWhiteSpace()); // NB govuk-frontend has styling adjustments for when hint-text is placed next to some other
...
var HintText = function HintText(props) {
  return React.createElement(StyledHint, props);
};
